    ...
    <div class="col-md-8 mx-auto">
      <div class="profile-form-wrap">
        <form class="edit_user" enctype="multipart/form-data" action="/users/update" accept-charset="UTF-8" method="post">
          ...
          <div class="form-group">
            <label for="user_profile_text">Self-introduction</label>
            <input autofocus="autofocus" class="form-control" type="text" value="{{ old('user_profile_text',$user->profile_text) }}" name="user_profile_text" />
          </div>
          ...
          <input type="submit" name="commit" value="Change" class="btn btn-primary" data-disable-with="変更する" />
        </div>
      </form>
    </div>
  </div>
